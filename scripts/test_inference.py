...
def capture_board_scene_pcd(
    ...
    if mode == 'from_disk':
        ...
        points_anchor = maybe_downsample(points_anchor, 1024, 'fps')
...
def capture_inhand_pcd(
    ...
    if mode == 'from_disk':
        ...
        points_action = maybe_downsample(points_action, 1024, 'fps')
